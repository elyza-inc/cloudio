...
# https://github.com/allenai/allennlp/blob/4434a83c27dd57dee3bf7989507e2d4271749a37/allennlp/common/tqdm.py
# TODO: 中身ちゃんと理解していないのでちゃんと理解する
...
class Tqdm:
    ...
    def set_slower_interval(use_slower_interval: bool) -> None:
        """
        If `use_slower_interval` is `True`, we will dramatically slow down `tqdm's`
        default output rate.  `tqdm's` default output rate is great for interactively
        watching progress, but it is not great for log files.  You might want to set
        this if you are primarily going to be looking at output through log files, not
        the terminal.
        """
